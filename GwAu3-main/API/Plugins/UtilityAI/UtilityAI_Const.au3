...
Global Enum $GC_UAI_TARGET_MODE_CALL = 0, $GC_UAI_TARGET_MODE_FOLLOW
Global $g_i_TargetMode = $GC_UAI_TARGET_MODE_CALL
Global $g_i_FightMode = 1
Global Enum $g_i_FinisherMode, $g_i_PressureMode
Global Const $GC_I_UAI_OVERRIDE_FORCE_TARGET = 0xF1A6 
...
Global Const $GC_UAI_WEAPONSET_OffensiveScore = 6    
Global Const $GC_UAI_WEAPONSET_DefensiveScore = 7   
Global Const $GC_UAI_WEAPONSET_CastingScore = 8     
Global Const $GC_UAI_WEAPONSET_EnchantScore = 9     
Global Const $GC_UAI_WEAPONSET_IsRanged = 10        
Global Const $GC_UAI_WEAPONSET_HasShield = 11       
Global Const $GC_UAI_WEAPONSET_HasVampiric = 12     
Global Const $GC_UAI_WEAPONSET_HasZealous = 13      
...
Global $g_ai_Best_Ranged_Set[2] = [0, 0]      
Global $g_ai_Best_Vampiric_Set[2] = [0, 0]    
Global $g_ai_Best_Zealous_Set[2] = [0, 0]     
...
Global $g_as2_FocusShieldWeaponsInscription[34][3] = [ _
	...
	["Live for Today",					"Energy +15 (Regen -1)", 				"0F00D822"], _ 
