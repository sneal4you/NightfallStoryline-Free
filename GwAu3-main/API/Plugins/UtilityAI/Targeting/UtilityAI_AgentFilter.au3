...
Func UAI_Filter_IsExploitableCorpse($a_i_AgentID)
	Return UAI_GetAgentInfoByID($a_i_AgentID, $GC_UAI_AGENT_IsExploitableCorpse) 
EndFunc
Func UAI_Filter_IsDiseased($a_i_AgentID)
	Return UAI_AgentHasVisibleEffect($a_i_AgentID, $GC_I_EFFECT_TYPE_STATUS, $GC_I_EFFECT_ID_DISEASED) 
EndFunc
Func UAI_Filter_IsDazed($a_i_AgentID)
	Return UAI_AgentHasVisibleEffect($a_i_AgentID, $GC_I_EFFECT_TYPE_STATUS, $GC_I_EFFECT_ID_DAZED) 
EndFunc
Func UAI_Filter_IsWeakness($a_i_AgentID)
	Return UAI_AgentHasVisibleEffect($a_i_AgentID, $GC_I_EFFECT_TYPE_STATUS, $GC_I_EFFECT_ID_WEAKNESS) 
EndFunc
Func UAI_Filter_IsPoisoned($a_i_AgentID)
	Return UAI_AgentHasVisibleEffect($a_i_AgentID, $GC_I_EFFECT_TYPE_STATUS, $GC_I_EFFECT_ID_POISONED) 
EndFunc
Func UAI_Filter_IsBlind($a_i_AgentID)
	Return UAI_AgentHasVisibleEffect($a_i_AgentID, $GC_I_EFFECT_TYPE_STATUS, $GC_I_EFFECT_ID_BLINDED) 
EndFunc
Func UAI_Filter_IsBurning($a_i_AgentID)
	Return UAI_AgentHasVisibleEffect($a_i_AgentID, $GC_I_EFFECT_TYPE_STATUS, $GC_I_EFFECT_ID_BURNING) 
EndFunc
Func UAI_Filter_IsBleeding($a_i_AgentID)
	Return UAI_AgentHasVisibleEffect($a_i_AgentID, $GC_I_EFFECT_TYPE_STATUS, $GC_I_EFFECT_ID_BLEEDING) 
EndFunc
