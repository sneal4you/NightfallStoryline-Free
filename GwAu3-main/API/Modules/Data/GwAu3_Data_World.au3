...
Func World_GetWorldInfo($a_s_Info = "")
    ...
    Switch $a_s_Info
        ...
        Case "MessageBuffArray" 
            Return Memory_Read($l_p_Ptr + 0x4, "ptr")
        Case "DialogBuffArray" 
        ...
        Case "MerchItemArray2" 
            Return Memory_Read($l_p_Ptr + 0x34, "ptr")
        Case "MerchItemArray2Size" 
        ...
        Case "MissionObjectiveArray" 
            Return Memory_Read($l_p_Ptr + 0x564, "ptr")
        Case "MissionObjectiveArraySize" 
...
Global Const $c_MissionState_Primary = 1      
Global Const $c_MissionState_Expert = 2       
Global Const $c_MissionState_Master = 4       
